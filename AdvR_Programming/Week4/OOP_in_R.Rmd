...
## [Object Oriented Programming in R](http://rdpeng.github.io/RProgDA/object-oriented-programming.html)
...
The **two older object oriented systems** in R are called 
- `S3` and 
- `S4`, and the 
...
### [General Principles of OOP](http://rdpeng.github.io/RProgDA/object-oriented-programming.html#object-oriented-principles)

There a several key principles in object oriented programming which span across R’s object systems and other programming languages. 
...
### [S3](http://rdpeng.github.io/RProgDA/object-oriented-programming.html#s3)
...
In the **S3 system** you can *arbitrarily assign a class to any object*, which goes against most of what we discussed in the Object Oriented Principles section. 

Class assignments can be made: 
- using the `structure()` function, or you can 
...
#### S3 - Creating a constructor Function in S3
...
#### S3 - Specifiy generic methods for a class 
...
#### S3 - View all associated methods for a generic function
...
### [The S4 System - Adding the "Superclass" inheritance](http://rdpeng.github.io/RProgDA/object-oriented-programming.html#s4)

The S4 system is slightly more restrictive than S3, but it’s similar in many ways. 

To create a new class in S4 you need to use thesetClass() function. You need to specify two or three arguments for this function: 
...
- and **optionally** `contains` which includes the super-class of theyclass you’re specifying (if there is a super-class). 
...
In order to **implement a new generic method** you need to use: 
...
Now we need to actually define the function which we can to withsetMethod(). The setMethod() functions takes as arguments the name of the method as a string, the method signature which specifies the class of each argument for the method, and then the function definition of the method:
```{r}
...
### [The "Reference Classes" in R - Modern Object Oriented Programming in R](http://rdpeng.github.io/RProgDA/object-oriented-programming.html#reference-classes)
